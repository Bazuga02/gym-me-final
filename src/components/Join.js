...
const Join = () => {
  const { subtitle, image, btnText } = join;
  return (
    <section className=" bg-neutral-500  min-h-[537px]">
      <div className="container mx-auto">
        ...
        <div className=" flex flex-col  md:flex-row md:items-center  md:-space-x-12 -space-y-24 lg:-space-y-0  ">
          {/* iamge */}
          <div
            className=" -mt-[80px]   max-w-[276px] md:max-w-[400px] lg:max-w-[480px]  "
            data-aos="fade-right"
            data-aos-offset="100"
            data-aos-delay="200"
          >
          ...
          >
            <h2 className=" h1 md:text-[60px] md:leading-[62px] mb-4 lg:mb-6 text-white ">
              Wanna Join <span className=" text-primary-200 ">&</span> be Fit?
            </h2>
            <p className=" text-body-sm md:text-body-md text-white mb-4 lg:mb-6 max-w-[348px] md:max-w-[470px] lg:max-w-[490px] ">
              {subtitle}
            </p>
