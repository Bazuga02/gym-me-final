...
const PlanList = ({ plans }) => {
  ...
  return (
    <div className=" flex flex-collg:flex-row items-center justify-center max-w-[1280px] mx-auto gap-y-4">
...
// ```In this example, I've imported the `BsCheckCircleFill` component from `react-icons/bs` at the beginning of the component. You should be able to use the `BsCheckCircleFill` component in the rest of the code now.
